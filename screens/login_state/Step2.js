...
const Step02Components = [
  {
    name: "กรอกเลขประจำตัวประชาชน",
  },
  {
    name: "กรอกเลขหลังประจำตัวประชาชน",
  },
];
...
const Step2 = ({ step }) => {
  ...
  return (
    <View w="100%">
      <VStack ml="10%"  h="80%">
        <View mb='5%'> 
        <TextLoginLabel>2</TextLoginLabel>
        <TextLoginLabel>เลขประจำตัวประชาชน</TextLoginLabel >
        </View>
     
        {Step02Components.map((data, index) => {
            return (
